<x-layouts.customer title="Tambah Kendaraan">
    ...
    <div class="max-w-3xl space-y-6">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-brand-steel">
                Tambahkan data kendaraan Anda untuk memudahkan proses booking servis.
            </p>
        </div>
            ...
            <form action="{{ route('customer.vehicles.store') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    ...
                    <div>
                        ...
                        <input type="number" id="year" name="year" value="{{ old('year') }}" min="2010"
                            max="{{ date('Y') }}"
